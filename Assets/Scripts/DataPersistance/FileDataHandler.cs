...
public class FileDataHandler
{
    ...
    public void Delete(string profileId)
    {
        ...
        {
            Debug.LogError("Failed to delete profile data for profileId: " + profileId + " at path " + " \n" + e);
        }
    }  
    ...
    {
        string mostRecentlProfileId = null;
        ...
        foreach (KeyValuePair<string, GameData> pair in profilesGameData)
        {
            ...
            if (mostRecentlProfileId == null)
            {
                mostRecentlProfileId = profileId;
            }
            // otherwise, compare to see which date is the most recent
            else
            {
                DateTime mostRecentDateTime = DateTime.FromBinary(profilesGameData[mostRecentlProfileId].lastUpdated);
